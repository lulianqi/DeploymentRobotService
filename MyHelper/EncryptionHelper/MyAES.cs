...
namespace MyCommonHelper.EncryptionHelper
{
    public class MyAES
    {
        ...
        {
            return MyEncryption.SymmetricEncrypt(PlainText, yourKey, yourIV, yourCipherMode, yourPaddingMode, SymmetricAlgorithmType.AES);
        }
        ...
        {
            return MyEncryption.SymmetricDecrypt(CypherText, yourKey, yourIV, yourCipherMode, yourPaddingMode, SymmetricAlgorithmType.AES);
        }
    }
}
